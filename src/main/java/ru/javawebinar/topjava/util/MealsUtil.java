...
public class MealsUtil {
    public static final int CALORIES_PER_DATE = 2_000;

    public static void main(String[] args) {
        List<Meal> meals = getTestData();

        List<MealTo> mealsTo = getFilteredMealTos(meals, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000);
    ...
    public static List<MealTo> getMealTos(List<Meal> meals, int caloriesPerDay) {
        return filteredByStreams(meals, caloriesPerDay, meal -> true);
    }

    public static List<MealTo> getFilteredMealTos(List<Meal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
